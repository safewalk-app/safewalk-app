...
-- FINAL VERSION: Adapted to exact schema (no priority/opted_out columns)
...
-- Strategy: Takes the first emergency contact (ORDER BY created_at)
-- ============================================================================
...
BEGIN
  ...
  -- Check daily SMS quota (for alert and test types)
  SELECT COUNT(*)
  INTO v_daily_count
  ...
  IF v_subscription_active THEN
    -- Check daily SMS quota for alert/test
    ...
    -- Subscription user: allowed (no credit deduction)
...
-- ============================================================================
-- These indexes optimize the most common queries used by the RPC functions
...
ON public.users(subscription_active);

-- ============================================================================
-- 5. CONFIRM MIGRATION
-- ============================================================================
SELECT 'RPC functions created successfully - Final version adapted to schema' as migration_status;
