...
const rawBundleId = 'space.manus.safewalk.app.t20250119065400';
const bundleId =
  rawBundleId
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocationWhenInUseUsageDescription:
        "SafeWalk a besoin de votre position GPS pour partager votre localisation en cas d'alerte d'urgence à vos contacts.",
      NSLocationAlwaysAndWhenInUseUsageDescription:
        "SafeWalk utilise votre position pour envoyer votre localisation à vos contacts d'urgence si vous ne confirmez pas votre retour.",
    },
  },
  android: {
    adaptiveIcon: {
